  ...
  return (
    <>
      <div className="col-span-2 mt-4 grid grid-cols-[60%_auto] gap-3">
        ...
        <button data-testid='clear' className="flex items-center place-content-evenly bg-neutral-900 hover:bg-blue-900 hover:font-bold focus:bg-red-900 focus:font-bold" onClick={handleClick} type="button">
